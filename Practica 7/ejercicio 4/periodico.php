...
<body>
    ...
    <form action="periodico.php" method="post"> 
        ...
        <input type="radio" name="noticia" value="politica" <?php if(isset($_COOKIE['noticia'])){if ($_COOKIE['noticia'] == 'politica') echo 'checked';} ?> > Noticia política <br>
        <input type="radio" name="noticia" value="economica" <?php  if(isset($_COOKIE['noticia'])){if ($_COOKIE['noticia'] == 'economica') echo 'checked';} ?>> Noticia económica<br>
        <input type="radio" name="noticia" value="deportiva" <?php  if(isset($_COOKIE['noticia'])){if ($_COOKIE['noticia'] == 'deportiva') echo 'checked';} ?>> Noticia deportiva
